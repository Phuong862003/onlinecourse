...
// Lấy tất cả các nút submit trong form
// const submitButtons = document.querySelectorAll('button[name="submit"]');

// // Lặp qua từng nút và thêm sự kiện click
// submitButtons.forEach(button => {
//     button.addEventListener('click', function() {
//         // Lấy giá trị action từ thuộc tính data-action của nút
//         const action = this.getAttribute('data-action');
        
//         // Gán giá trị action vào trường ẩn
//         document.getElementById('action').value = action;

//         // Kiểm tra action và thực hiện các xử lý tương ứng
//         if (action === 'register') {
//             if (!checkRequired([username, email, password])) {
//                 // Các xử lý khác cho đăng ký
//             }
//         } else if (action === 'login') {
//             if (!checkRequiredLg([lgEmail, lgPassword])) {
//                 checkEmail2(lgEmail);
//                 // Các xử lý khác cho đăng nhập
//             }
//         }
